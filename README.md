...
| `phpmyadmin_allow_deny_order` | `allow,deny`                                | See [the phpMyAdmin `$cfg['Servers'][$i]['AllowDeny']['order']` documentation](https://docs.phpmyadmin.net/en/latest/config.html#cfg_Servers_AllowDeny_order)  |
| `phpmyadmin_allow_deny_rules` | `- "deny {{ phpmyadmin_user }} from all"`   | See [the phpMyAdmin `$cfg['Servers'][$i]['AllowDeny']['rules']` documentation](https://docs.phpmyadmin.net/en/latest/config.html#cfg_Servers_AllowDeny_rules)  |
